...
const BudgetInvestmentCalculator = () => {
    ...
    <header className={`fixed top-0 right-0 left-16 h-16 z-10 flex items-center justify-between px-6 ${darkMode ? 'bg-gray-800' : 'bg-pink-100'}`}>
     ...
     <div className="max-w-6xl mx-auto mt-16">
       ...
       <div className="text-center mb-10 transform transition-all duration-700 ease-in-out">
         ...
         <p className={darkMode ? "text-gray-300" : "text-gray-600"}>Plan your financial future with our easy-to-use tools</p>
       </div>

       {/* Tab Navigation */}
       <div className="flex justify-center mb-8">
         <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-full shadow-md p-1 flex`}>
           <button
             onClick={() => { setActiveTab('budget'); triggerAnimation(); }}
             className={`flex items-center px-4 py-2 rounded-full transition-all duration-300 ${activeTab === 'budget' ? 'bg-pink-500 text-white shadow-md' : `${darkMode ? 'text-gray-300 hover:bg-gray-700' : 'text-gray-600 hover:bg-pink-100'}`}`}
           >
           ...
           <button
             ...
             className={`flex items-center px-4 py-2 rounded-full transition-all duration-300 ${activeTab === 'savings' ? 'bg-pink-500 text-white shadow-md' : `${darkMode ? 'text-gray-300 hover:bg-gray-700' : 'text-gray-600 hover:bg-pink-100'}`}`}
           >
           ...
           <button
             ...
             className={`flex items-center px-4 py-2 rounded-full transition-all duration-300 ${activeTab === 'investment' ? 'bg-pink-500 text-white shadow-md' : `${darkMode ? 'text-gray-300 hover:bg-gray-700' : 'text-gray-600 hover:bg-pink-100'}`}`}
           >
         ...
         {activeTab === 'budget' && (
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-lg p-6 transform transition-all hover:shadow-xl`}>
               ...
               <div className="mb-6">
                 <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Monthly Income</label>
                 <div className="relative">
                   <span className={darkMode ? "absolute left-3 top-3 text-gray-500" : "absolute left-3 top-3 text-gray-400"}>$</span>
                   <input
                     type="number"
                     value={income}
                     onChange={(e) => setIncome(parseFloat(e.target.value) || 0)}
                     className={`w-full pl-8 pr-4 py-2 border ${darkMode ? 'border-pink-800 bg-gray-700 text-white focus:ring-pink-500' : 'border-pink-200 focus:ring-pink-300'} rounded-lg focus:outline-none focus:ring-2`}
                   />
                 </div>
               </div>
               ...
               <div className="mb-6">
                 <div className="flex justify-between items-center mb-2">
                   <label className={darkMode ? "text-gray-300" : "text-gray-600"}>Expenses</label>
                 ...
                 <div className="max-h-64 overflow-y-auto mb-4 pr-2 styled-scrollbar">
                   {expenses.map((expense) => (
                     <div key={expense.id} className={`flex justify-between items-center mb-2 p-2 ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-pink-50 hover:bg-pink-100'} rounded-lg group transition-all`}>
                 ...
                 <div className="grid grid-cols-5 gap-2">
                   <input
                     ...
                     className={`col-span-2 px-3 py-2 border ${darkMode ? 'border-pink-800 bg-gray-700 text-white focus:ring-pink-500' : 'border-pink-200 focus:ring-pink-300'} rounded-lg focus:outline-none focus:ring-2`}
                   />
                   <div className="relative col-span-2">
                     <span className={darkMode ? "absolute left-3 top-2 text-gray-500" : "absolute left-3 top-2 text-gray-400"}>$</span>
                     <input
                       type="number"
                       placeholder="Amount"
                       value={newAmount}
                       onChange={(e) => setNewAmount(e.target.value)}
                       className={`w-full pl-8 pr-2 py-2 border ${darkMode ? 'border-pink-800 bg-gray-700 text-white focus:ring-pink-500' : 'border-pink-200 focus:ring-pink-300'} rounded-lg focus:outline-none focus:ring-2`}
                     />
                   </div>
                   <button
                     onClick={addExpense}
             ...
             <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-lg p-6 transform transition-all hover:shadow-xl`}>
               ...
               <div className="mb-6">
                 <div className={darkMode ? "bg-gray-700 p-4 rounded-xl" : "bg-pink-50 p-4 rounded-xl"}>
                   <div className="flex justify-between mb-2">
                     <span className={darkMode ? "text-gray-300" : "text-gray-600"}>Income:</span>
                     <span className="font-medium">${income}</span>
                   </div>
                   <div className="flex justify-between mb-2">
                     <span className={darkMode ? "text-gray-300" : "text-gray-600"}>Expenses:</span>
                     <span className="font-medium">${totalExpenses}</span>
                   </div>
                   <div className={darkMode ? "h-px bg-gray-600 my-2" : "h-px bg-pink-200 my-2"}></div>
               ...
               <div className="mb-6">
                 <h3 className={darkMode ? "text-lg font-medium text-gray-200 mb-3" : "text-lg font-medium text-gray-700 mb-3"}>Expense Distribution</h3>
                 ...
                 <div className="space-y-3">
                   {budgetDistribution.map((item) => (
                     <div key={item.id} className="space-y-1">
                       ...
                       <div className={`w-full ${darkMode ? 'bg-gray-700' : 'bg-gray-100'} rounded-full h-4 overflow-hidden`}>
                         <div
               ...
               <div className={darkMode ? "bg-gray-700 p-4 rounded-xl" : "bg-pink-50 p-4 rounded-xl"}>
                 <h3 className={darkMode ? "text-lg font-medium text-gray-200 mb-2" : "text-lg font-medium text-gray-700 mb-2"}>Budget Health</h3>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-lg p-6 transform transition-all hover:shadow-xl`}>
               ...
               <div className="space-y-4">
                 <div>
                   <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Savings Goal</label>
                   <div className="relative">
                     <span className={darkMode ? "absolute left-3 top-3 text-gray-500" : "absolute left-3 top-3 text-gray-400"}>$</span>
                     <input
                       type="number"
                 ...
                 <div>
                   <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Current Savings</label>
                   <div className="relative">
                     <span className={darkMode ? "absolute left-3 top-3 text-gray-500" : "absolute left-3 top-3 text-gray-400"}>$</span>
                     <input
                       type="number"
                 ...
                 <div>
                   <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Monthly Contribution</label>
                   <div className="relative">
                     <span className={darkMode ? "absolute left-3 top-3 text-gray-500" : "absolute left-3 top-3 text-gray-400"}>$</span>
                     <input
                       type="number"
                 ...
                 <div>
                   <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Annual Interest Rate (%)</label>
                   <div className="relative">
                     <input
                       type="number"
                       value={interestRate}
                       onChange={(e) => setInterestRate(parseFloat(e.target.value) || 0)}
                       className={`w-full px-4 py-2 border ${darkMode ? 'border-pink-800 bg-gray-700 text-white focus:ring-pink-500' : 'border-pink-200 focus:ring-pink-300'} rounded-lg focus:outline-none focus:ring-2`}
                     />
                     <span className={darkMode ? "absolute right-3 top-3 text-gray-500" : "absolute right-3 top-3 text-gray-400"}>%</span>
                   </div>
                 </div>
               </div>
             </div>
             ...
             <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-lg p-6 transform transition-all hover:shadow-xl`}>
               ...
               <div className="space-y-6">
                 <div className={darkMode ? "bg-gray-700 p-4 rounded-xl" : "bg-pink-50 p-4 rounded-xl"}>
                   <h3 className={darkMode ? "text-lg font-medium text-gray-200 mb-3" : "text-lg font-medium text-gray-700 mb-3"}>Time to Reach Goal</h3>
                   ...
                   {monthsToGoal() === Infinity ? (
                     ...
                     <div className="text-center">
                       ...
                       <p className={darkMode ? "text-gray-300" : "text-gray-600"}>until you reach your goal</p>
                     </div>
                   )}
                 </div>
                 ...
                 <div>
                   ...
                   <div className={`w-full ${darkMode ? 'bg-gray-700' : 'bg-gray-100'} rounded-full h-6 overflow-hidden`}>
                     <div
                 ...
                 <div className={darkMode ? "bg-gray-700 p-4 rounded-xl" : "bg-pink-50 p-4 rounded-xl"}>
                   <h3 className={darkMode ? "text-lg font-medium text-gray-200 mb-3" : "text-lg font-medium text-gray-700 mb-3"}>Savings Tips</h3>
                   <ul className={darkMode ? "text-gray-300 space-y-2" : "text-gray-600 space-y-2"}>
         ...
         {activeTab === 'investment' && (
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-lg p-6 transform transition-all hover:shadow-xl`}>
               ...
               <div className="space-y-4">
                 <div>
                   <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Initial Investment</label>
                   <div className="relative">
                     <span className={darkMode ? "absolute left-3 top-3 text-gray-500" : "absolute left-3 top-3 text-gray-400"}>$</span>
                     <input
                       type="number"
                 ...
                 <div>
                   <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Time Period (years)</label>
                   <input
                     type="range"
                     min="1"
                     max="40"
                     ...
                     className={`w-full h-2 ${darkMode ? 'bg-pink-800' : 'bg-pink-200'} rounded-lg appearance-none cursor-pointer`}
                   />
                   <div className={`text-center ${darkMode ? 'text-gray-300' : 'text-gray-700'} mt-1`}>{investmentYears} years</div>
                 </div>

                 <div>
                   <label className={darkMode ? "block text-gray-300 mb-2" : "block text-gray-600 mb-2"}>Expected Annual Return (%)</label>
                   <div className="relative">
                     <input
                       type="number"
 ...
 <li className="flex items-start">
 <ArrowRight className={`h-4 w-4 mr-2 ${darkMode ? 'text-pink-400' : 'text-pink-500'} mt-1 flex-shrink-0`} />
 ...
 <button
  ...
  className={`w-full py-3 ${darkMode ? 'bg-pink-600 hover:bg-pink-700' : 'bg-pink-500 hover:bg-pink-600'} text-white rounded-lg transition-colors flex items-center justify-center font-medium`}
>
